...
describe('ai/prompts/review', () => {
  describe('buildReviewPrompt', () => {
    ...
    test('should include custom rules', () => {
      ...
      const fileName = 'test.js';
      const customRules = [
        { name: 'no-console', severity: 'P2', pattern: 'console', message: 'No console' },
      ];

      const prompt = buildReviewPrompt(diff, fileName, customRules);
